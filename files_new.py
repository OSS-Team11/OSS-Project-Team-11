...
init_bttn = tk.Button(frame_git, text="init", font=("Arial", 12), relief="flat", bg="white", fg="black")
...
unstage_bttn = tk.Button(frame_git, text="restore --cached", font=("Arial", 12), relief="flat", bg="white", fg="black")
rm_bttn = tk.Button(frame_git, text="remove", font=("Arial", 12), relief="flat", bg="white", fg="black")
rm_cached_bttn = tk.Button(frame_git, text="rm --cached", font=("Arial", 12), relief="flat", bg="white", fg="black")
mv_bttn = tk.Button(frame_git, text="move", font=("Arial", 12), relief="flat", bg="white", fg="black")
commit_bttn = tk.Button(frame_git, text="commit", font=("Arial", 12), relief="flat", bg="white", fg="black", command=new_window)
init_bttn.grid(column=0, row=0)
add_bttn.grid(column=1, row=0)
restore_bttn.grid(column=2, row=0)
unstage_bttn.grid(column=3, row=0)
rm_bttn.grid(column=4, row=0)
rm_cached_bttn.grid(column=5, row=0)
mv_bttn.grid(column=6, row=0)
commit_bttn.grid(column=7, row=0)
